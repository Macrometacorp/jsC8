import Instance from "c8-instance-manager/lib/Instance";
import InstanceManager from "c8-instance-manager/lib/InstanceManager";
...
describeIm("Single-server active failover", function() {
  ...
  beforeEach(async () => {
    ...
    await im.startSingleServer("jsC8", 2);
