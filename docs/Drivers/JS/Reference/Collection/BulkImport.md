...
[HTTP API for bulk imports](https://docs.macrometa.io/jsC8/latest/HTTP/BulkImports/index.html).
...
[the HTTP API documentation for bulk imports](https://docs.macrometa.io/jsC8/latest/HTTP/BulkImports/).
