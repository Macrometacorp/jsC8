...
[HTTP API for simple queries](https://docs.macrometa.io/jsC8/latest/HTTP/SimpleQuery/index.html).
...
* **opts**: `Object` (optional)
  ...
  [the HTTP API for returning all documents](https://docs.macrometa.io/jsC8/latest/HTTP/SimpleQuery/index.html#return-all-documents).
...
* **opts**: `Object` (optional)
  ...
  For information on the possible options see
  [the HTTP API for returning the first document of a collection](https://docs.macrometa.io/jsC8/2.8/HttpSimpleQuery/#first-document-of-a-collection).
...
* **opts**: `Object` (optional)
  ...
  For information on the possible options see
  [the HTTP API for returning the last document of a collection](https://docs.macrometa.io/jsC8/2.8/HttpSimpleQuery/#last-document-of-a-collection).
...
* **opts**: _Object_ (optional)
  ...
  For information on the possible options see
  [the HTTP API for fetching documents by example](https://docs.macrometa.io/jsC8/latest/HTTP/SimpleQuery/index.html#find-documents-matching-an-example).
...
* **opts**: _Object_ (optional)
  ...
  For information on the possible options see
  [the HTTP API for removing documents by example](https://docs.macrometa.io/jsC8/latest/HTTP/SimpleQuery/index.html#remove-documents-by-example).
...
* **opts**: _Object_ (optional)
  ...
  For information on the possible options see
  [the HTTP API for replacing documents by example](https://docs.macrometa.io/jsC8/latest/HTTP/SimpleQuery/index.html#replace-documents-by-example).
...
* **opts**: _Object_ (optional)
  ...
  For information on the possible options see
  [the HTTP API for updating documents by example](https://docs.macrometa.io/jsC8/latest/HTTP/SimpleQuery/index.html#update-documents-by-example).
...
* **opts**: _Object_ (optional)
  ...
  For information on the possible options see
  [the HTTP API for removing documents by keys](https://docs.macrometa.io/jsC8/latest/HTTP/SimpleQuery/index.html#remove-documents-by-their-keys).
...
* **opts**: _Object_ (optional)
  ...
  For information on the possible options see
  [the HTTP API for fulltext queries](https://docs.macrometa.io/jsC8/latest/HTTP/Indexes/Fulltext.html).
